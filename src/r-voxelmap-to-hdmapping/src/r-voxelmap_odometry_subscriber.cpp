...
int main(int argc, char **argv)
{
    ...
    for (const rosbag::MessageInstance& m : view) {
        if (m.getTopic() == "/rvoxelmap/cloud_registered") {
            ROS_INFO("Received message on topic: /rvoxelmap/cloud_registered");
        ...
        if (m.getTopic() == "/rvoxelmap/aft_mapped_to_init") {
            ROS_INFO("Received message on topic: /rvoxelmap/aft_mapped_to_init");
